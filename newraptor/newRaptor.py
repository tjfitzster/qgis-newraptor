...
from .newRaptor_dialog import new_raptorDialog
...
class new_raptor:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('new_raptor', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Add New Raptors Nest'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            QMessageBox.information(self.dlg, "Message", "New Nest ID: {}".format(str(valNestID)))
            ...
            for linear in linears:
                ...
                if valDistance < valBuffer:
                    ...
                    dlgTable.tblImpacts.setItem(row, 2, QTableWidgetItem('{:.4f}'.format(valDistance)))
